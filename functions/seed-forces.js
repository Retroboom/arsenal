...
const forces = [
...

  {
    ...
    platoons: [
      ...
      { name: 'Artillery Battery', teams: [{ unitId: 'us-leader', qty: 1 }, { unitId: 'us-fo', qty: 1 }, { unitId: 'us-gun-105mm-howitzer', qty: 3 }] },
    ],
  },

  {
    ...
    platoons: [
      ...
      { name: 'Light Tank Platoon', teams: [{ unitId: 'us-tank-m5-stuart', qty: 3 }] },
      { name: 'Recon Platoon', teams: [{ unitId: 'us-ac-m8', qty: 2 }] },
      { name: 'Artillery Battery', teams: [{ unitId: 'us-fo', qty: 1 }, { unitId: 'us-spa-m7-priest', qty: 3 }, { unitId: 'us-transport-halftrack', qty: 1 }] },
    ],
  },
...

  {
    ...
    nations: ['Germany'],
    platoons: [
      { name: '1st Grenadier Platoon', teams: [{ unitId: 'de-leader', qty: 1 }, { unitId: 'de-inf-rifle-mg', qty: 6 }, { unitId: 'de-inf-panzerfaust', qty: 6 }] },
      { name: '2nd Grenadier Platoon', teams: [{ unitId: 'de-leader', qty: 1 }, { unitId: 'de-inf-rifle-mg', qty: 6 }, { unitId: 'de-inf-panzerfaust', qty: 6 }] },
      { name: '3rd Grenadier Platoon', teams: [{ unitId: 'de-leader', qty: 1 }, { unitId: 'de-inf-rifle-mg', qty: 6 }, { unitId: 'de-inf-panzerfaust', qty: 6 }] },
      { name: 'Anti-Tank Platoon', teams: [{ unitId: 'de-leader', qty: 1 }, { unitId: 'de-gun-pak40', qty: 3 }] },
...

  {
    ...
    notes: 'Soviet rifle company at full strength. Large four-squad platoons each include an organic HMG team. Backed by 82mm mortars, 45mm anti-tank guns, T-34s, and the 122mm howitzer.',
    ...
    platoons: [
      ...
      { name: 'Tank Platoon', teams: [{ unitId: 'sv-tank-t34-41', qty: 3 }] },
      { name: 'Artillery Battery', teams: [{ unitId: 'sv-leader', qty: 1 }, { unitId: 'sv-fo', qty: 1 }, { unitId: 'sv-gun-122mm-howitzer', qty: 3 }] },
    ],
  },

  {
    ...
    nations: ['Soviet Union'],
    platoons: [
      { name: '1st Tank Platoon', teams: [{ unitId: 'sv-tank-t34-41', qty: 3 }] },
      { name: '2nd Tank Platoon', teams: [{ unitId: 'sv-tank-t34-41', qty: 3 }] },
      { name: '3rd Tank Platoon', teams: [{ unitId: 'sv-tank-t34-41', qty: 3 }] },
      ...
      { name: 'Artillery Battery', teams: [{ unitId: 'sv-fo', qty: 1 }, { unitId: 'sv-spa-katyusha', qty: 3 }, { unitId: 'sv-transport-zis-truck', qty: 1 }] },
    ],
  },
...

  {
    ...
    notes: 'Standard British infantry company from NW Europe. Each rifle platoon carries a PIAT and 2" mortar as organic support. Backed by 6-pounder anti-tank guns, Churchill tanks, 3" mortars, and 25-pounder artillery.',
    nations: ['Britain'],
    platoons: [
      ...
      { name: 'Artillery Battery', teams: [{ unitId: 'br-leader', qty: 1 }, { unitId: 'br-fo', qty: 1 }, { unitId: 'br-gun-25pdr', qty: 3 }] },
    ],
  },

  {
    ...
    platoons: [
      ...
      { name: 'Artillery Battery', teams: [{ unitId: 'br-fo', qty: 1 }, { unitId: 'br-spa-sexton', qty: 3 }, { unitId: 'br-recon-universal-carrier', qty: 1 }] },
    ],
  },
